            ...
            {if $hookContentPlacement neq 3}
                ...
                <div id="contactTopBar">
                    <table>
                        ...
                        {* Customization CoreCorp8 use sic code as KvK nummer *}
			{if $contact_type == 'Organization'}
                            <tr><td class="label">KvK nummer</td>
                                <td>{$sic_code}</td>
                            </tr>
			{/if}
                        {* end CoreCorp8 *}
