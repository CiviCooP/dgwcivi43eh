{*
 ...
 | Marker       :   CoreCorp2                                         |
 | Description  :   Remove 'source' and 'external id' for all contacts|
 |                                                                    |
 | Date         :   28 Nov 2012                                       |
 | Marker       :   DGW33 (incident 28 11 12 002)                     |
 | Description  :   Remove button check for dedupes (check is already |
 |                  done in AJAX function, button is superfluous)     |
 |                                                                    |
 | Date         :   3 April 2013                                      |
 | Author       :   Erik Hommel (erik.hommel@civicoop.org)            |
 | Marker       :   BOS1303566                                        |
 | Description  :   Remark during testing: move Demographics block    |
 |                  to top                                            |
 +--------------------------------------------------------------------+
...
{else}
    <div class="crm-form-block crm-search-form-block">
                ...
                <div id="contactDetails">
                    ...
                    <table class="crm-section contact_source-section form-layout-compressed">
                        <tr class="last-row">
                            ...
                            {* Customization CoreCorp2 EE-atWork *}
                            {* remove source and external identifier *}
        ...
        {if $contactType == "Individual"}
            {include file="CRM/Contact/Form/Edit/Demographics.tpl"}
        {/if}    
        {foreach from = $editOptions item = "title" key="name"}
            {if $name != "Demographics" || $contactType != "Individual"}
