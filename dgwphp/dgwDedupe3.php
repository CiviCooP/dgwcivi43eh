 ...
 */
CRM_Core_DAO::executeQuery( "TRUNCATE TABLE dgw_suspects3");
...
function _checkAlready ( $c1, $c2 ) {
	...
	$checkQry = 
"SELECT COUNT(*) AS aantal FROM dgw_suspects2 WHERE (contact_id_1 = $c1 AND contact_id_2 = $c2) OR (contact_id_1 = $c2 AND contact_id_2 = $c1)";
