...
/*
 * tabel dgw_suspects2 leegmaken
 */
CRM_Core_DAO::executeQuery( "TRUNCATE TABLE dgw_suspects2");
...
foreach ( $suspectsDupe as $suspect ) {
	...
	$w = $suspect[2];
	/*
	 * alleen verwerken als contactpaar nog niet in suspects
	 */
	if ( _checkAlready( $c1, $c2 ) == false ) {
		/*
