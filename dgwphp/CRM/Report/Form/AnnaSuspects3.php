...
/*
 ...
 +--------------------------------------------------------------------+
 | De Goede Woning - report AnnaSuspects3 - 27 juni 2012              |
 | (Erik Hommel)                                                      |
 |                                                                    |
 +--------------------------------------------------------------------+
...
class CRM_Report_Form_AnnaSuspects3 extends CRM_Report_Form {
    ...
    function postProcess( ) {
		...
		$bsnQry = "
SELECT * FROM dgw_suspects3 order by last_name_1, middle_name_1, first_name_1";
