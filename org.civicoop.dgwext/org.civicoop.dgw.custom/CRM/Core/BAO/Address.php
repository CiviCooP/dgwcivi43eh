...
/*
 ...
 |                  in extension org.civicoop.dgw.custom              |
 +--------------------------------------------------------------------+
*/
...
ORDER BY civicrm_address.is_primary DESC, civicrm_address.location_type_id DESC, address_id ASC ";
  ...
  static function parseStreetAddress($streetAddress, $locale = NULL) {
    ...
    /*
     * DGW added nl_NLl as supported locale to suppress warning statement
     * Actual Dutch parsing is done in extension org.civicoop.dgw.custom
     */
